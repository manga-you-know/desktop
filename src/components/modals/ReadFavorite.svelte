        ...
        <div class="w-54 flex flex-col gap-1">
          <div class="flex gap-1 items-center justify-between">
            ...
            <Segment
              name="web"
              value={chaptersMode}
              onValueChange={(e) => (chaptersMode = e.value as "web" | "local")}
            >
              <Segment.Item value="web">
                <Icon class="w-5! h-5!" icon="tabler:world" />
              </Segment.Item>
              <Segment.Item value="local">
          ...
          <div
            class="bg-secondary rounded-xl relative w-53 h-76 overflow-hidden"
          >
            <div
              class={cn(
                "flex justify-center items-center h-76! w-53 absolute transition-all duration-300 ease-in-out",
            ...
            <div
              class={cn(
                "flex justify-center h-76! w-53! absolute left-0 top-0 transition-all duration-300 ease-in-out",
