    ...
    <div class="flex gap-6 w-full select-none">
      ...
      <div class="flex flex-col h-full justify-center gap-6 py-6">
        <div class="flex flex-col justify-center gap-2">
          ...
          >
          <Label class="text-md"
            >Here you'll get a patch notes on this update, v{version}</Label
          >
        </div>
        <div class="flex flex-col gap-2">
          <Label class="text-lg">New features</Label>
          <Label class="list-disc list-item">Nothing to say</Label>
          <!--
          ...
          <Label class="list-disc list-item"
            >Closing app in reader resulting in crash instead of a smooth close</Label
          >
          <Label class="list-disc list-item"
            >WeebCentral fixed again!!! (dumb error)
          </Label>
        </div>
      </div>
    </div>
