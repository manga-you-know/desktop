...
<DrawerPrimitive.Portal {...portalProps}>
  ...
  <DrawerPrimitive.Content
    ...
    class={cn(
      "filter-effects",
      "bg-background fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border ring-0 outline-none focus-visible:ring-0 focus-visible:outline-none",
