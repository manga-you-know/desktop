<script lang="ts">
  ...
  let panelsTitleLabel: Record<string, string> = {};
  //   Object.fromEntries(
...
<div class="relative flex justify-center p-2">
  ...
  >
    <Badge class="flex h-10 w-12 items-center justify-center" variant="outline">
