...
<template>
	<USlideover v-model:model-value="isOpen">
		...
		<div>
			...
			<div class="h-[calc(100vh-3rem)] bg-gray-800 rounded-xl m-1 p-1 flex flex-col overflow-y-scroll">
            <div 
            ...
            >
              ...
              <div class="inline-flex -space-x-px overflow-hidden rounded-md border border-gray-500 bg-slate-700 shadow-sm">
								<p v-if="chapter.chapter_id.includes(currentlyChapter.chapter_id)">~</p>
                <button 
                ...
                >
                  <i :class=" isReadedHere(chapter)? 'fa fa-check' : 'fa fa-minus'"/>
                </button>
              </div>
            </div>
          </div>
