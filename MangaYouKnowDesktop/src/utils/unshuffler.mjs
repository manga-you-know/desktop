class Unshuffler {
  ...
  init() {
    ...
    function _0x4b7e3b(_0xd1c90b, _0x55eb5c, _0x2a4bce) {
          ...
          (function _0x53f196(_0x598061, _0xa97de4) {
            ...
            if (_0xa97de4 && 'object' == _0x5ee98e) {
              for (_0x4cb136 in _0x598061)
                try {
                  _0x588b46.push(
                    _0x53f196(_0x598061[_0x4cb136], _0xa97de4 - 1),
                  );
                } catch (_0x1f24ad) {
                  //
                }
      ...
      return (
        (_0x1c4ba5.int32 = () => 0 | _0x1cf83a.g(4)),
        (_0x1c4ba5.quick = () => _0x1cf83a.g(4) / 4294967296),
        (_0x1c4ba5.double = _0x1c4ba5),
        _0x459744(_0x8285a6(_0x1cf83a.S), _0xb2d0a3),
        (
          _0x55eb5c.pass ||
          _0x2a4bce ||
          ((_0x4526b5, _0x337cae, _0x314183, _0x3034a8) => (
            _0x3034a8 &&
              (_0x3034a8.S && _0x1ef076(_0x3034a8, _0x1cf83a),
              (_0x4526b5.state = () => _0x1ef076(_0x1cf83a, {}))),
          ...
          _0x551239 =
            ...
            _0x4dddac[
              _0x45bef1 &
                ((_0x4dddac[_0x240549] =
                  _0x4dddac[
                    (_0x41a3c2 = _0x45bef1 & (_0x41a3c2 + _0x104e1c))
                  ]) +
                  (_0x4dddac[_0x41a3c2] = _0x104e1c))
            ];
        }
        return (this.i = _0x240549), (this.j = _0x41a3c2), _0x551239;
      })(256);
    }
  ...
  extractSeed(a) {
    return !/(number|string)/i.test(
      Object.prototype.toString.call(a).match(/^\[object (.*)\]$/)[1],
    ) && isNaN(a)
      ? Number(
          String((this.strSeed = a))
            .split('')
  ...
  async imgReverser(imageURI, a = 200, b = 'stay') {
    ...
    for (const i in f) {
      ...
      for ([j, k] of f[i].entries()) {
        var n = l[j];
        var o = Number.parseInt(n / m.cols);
  ...
  isObject(_0x36af8c) {
    ...
    return (
      null != _0x36af8c && ('object' == _0x293a47 || 'function' == _0x293a47)
    );
  }
  ...
  isSymbol(_0x2563af) {
    ...
    return (
      'symbol' == _0x68d5dc || ('object' == _0x68d5dc && null != _0x2563af)
    ); //&& '[object Symbol]' == getTag(_0x2563af);
  }
  ...
  toNumber(_0x40b6d8) {
    ...
    return _0x19ec12 || /^0o[0-7]+$/i.test(_0x40b6d8)
      ? Number.parseInt(_0x40b6d8.slice(2), _0x19ec12 ? 2 : 8)
  ...
  toFinite(a) {
    return a
      ? (a = this.toNumber(a)) !== 1e400 && a !== -1e400
        ? a == a
          ? a
          : 0
        : 1.7976931348623157e308 * (a < 0 ? -1 : 1)
      : 0 === a
        ? a
  ...
  createRange(a, b, c) {
    return (
      ...
      this.baseRange(
        a,
        b,
        (c = void 0 === c ? (a < b ? 1 : -1) : this.toFinite(c)),
        false,
      )
    );
  }
